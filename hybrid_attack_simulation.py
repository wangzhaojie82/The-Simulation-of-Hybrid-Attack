'''
The implementation of " hybrid (or one-time-releasing) Selfish mining"
'''
import random
import time
import sys
...
class Selfish_Mining:
    ...
    def __init__(self, **d):
        ...
        self.__publishParam = d['rho'] # the probability of publishing private blocks, i.e., param \rho in the paper
    ...
    def On_Honest_Miners(self):
        ...
        if self.__delta == 0:
            ...
            # --> either it appends the honest chain => 2 blocks for honest miners
    ...
    def actualize_results(self):
        ...
        if self.__honestsValidBlocks or self.__selfishValidBlocks:
            ...
            # This code is to calculate the relative revenue
